...
export default function ScraperImmo() {
    ...
    const DEPARTEMENTS = [
        ...
        "Ardennes", "Ariège", "Aube", "Aude", "Aveyron", "Bas-Rhin", "Haut-Rhin", "Bouches-du-Rhône", "Calvados",
        "Cantal", "Charente", "Charente-Maritime", "Cher", "Corrèze", "Corse-du-Sud", "Haute-Corse", "Côte-d'Or",
        "Côtes-d'Armor", "Creuse", "Deux-Sèvres", "Dordogne", "Doubs", "Drôme", "Eure", "Eure-et-Loir",
        ...
        "Seine-et-Marne", "Yvelines", "Somme", "Tarn", "Tarn-et-Garonne", "Var", "Vaucluse", "Vendée", "Vienne",
    ...
    return (
        ...
        >
            ...
            {/* === Prix médian marché === */}
            {median && (
                <p style={{ textAlign: "center", color: "#f1c40f", fontWeight: "bold" }}>
                    📊 Prix médian marché (Etalab) pour {departement} : {median.toLocaleString()} €/m²
                </p>
            )}
